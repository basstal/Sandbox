...
namespace Sandbox
{
    ...
    {
    public:
        RenderAttachments(const std::shared_ptr<Device>& device, const std::shared_ptr<RenderPass>& renderPass, VkExtent2D extent2D, const std::shared_ptr<ImageView>& inResolveImageView);
