...
class CLASS() GameObject : public ISerializable<GameObject>
{
  public:
    ...
    template <DerivedFromIComponent T> std::shared_ptr<T> AddComponent();

    template <DerivedFromIComponent T> std::shared_ptr<T> GetComponent();
...
template <DerivedFromIComponent T> std::shared_ptr<T> GameObject::GetComponent()
{
...
template <DerivedFromIComponent T> std::shared_ptr<T> GameObject::AddComponent()
{
