...
// // 特化用于没有参数的情况
// template <typename T>
// using DelegateNoArg = Delegate<void>;
//
//
// template <typename AbstractData, bool IsEmpty = std::is_void_v<AbstractData>>
// struct DelegateTypeSelector
// {
//     using DelegateType = Delegate<AbstractData>;
// };
//
//
// template <typename AbstractData>
// struct DelegateTypeSelector<AbstractData, true>
// {
//     using DelegateType = DelegateNoArg<void>;
// };
...
public:
    ...
    //  */
    // template <typename = std::enable_if_t<!std::is_void_v<AbstractData>>,
    //           typename = void>
...
// template <typename AbstractData>
// template <typename>
// void TDataBinding<AbstractData>::SetData()
// {
//     Trigger();
// }
