...
void Shader::LoadUniform(const glslang::TObjectReflection& uniform, VkShaderStageFlagBits stageFlag)
{
...
void Shader::LoadAttribute(const glslang::TObjectReflection& attribute)
{
...
void Shader::LoadUniformBlock(const glslang::TObjectReflection& uniformBlock, VkShaderStageFlagBits stageFlag)
{
...
VkShaderModule Shader::GetShaderModule(VkShaderStageFlagBits stageFlag)
{
