...
public:
	...
	void Cleanup();
	void BeginRenderPass(VkCommandBuffer vkCommandBuffer, VkFramebuffer vkFramebuffer, VkExtent2D vkExtent2D, VkClearColorValue clearColorValue, VkClearDepthStencilValue clearDepthStencilValue);
};
