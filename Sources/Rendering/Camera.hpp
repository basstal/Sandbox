...
#include "Persistence/CameraPersistence.hpp"
...
{
public:
    std::shared_ptr<CameraPersistence> persistence;
    // Camera Attributes
    glm::vec3 front;
    glm::vec3 up;
    glm::vec3 right;
    ...
    float zoom; // TODO:replace with fov


    Camera(glm::vec3 inWorldUp, std::shared_ptr<CameraPersistence> inPersistence);
