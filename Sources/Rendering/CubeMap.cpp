...
CubeMap::CubeMap(const std::shared_ptr<Device>& device, const std::shared_ptr<GameCore::Image>& imageResource, const std::shared_ptr<CommandResource>& commandResource, uint32_t inSize,
