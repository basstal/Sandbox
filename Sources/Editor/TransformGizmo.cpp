...
//     m_renderAttachments = std::make_shared<RenderAttachments>(m_renderer->device, m_renderer->renderPass, m_renderer->swapchain->imageExtent, nullptr);
//     m_renderTarget = std::make_shared<RenderTarget>(m_renderer->device, m_renderer->renderPass, m_renderer->swapchain->imageExtent, m_renderAttachments);
// }
