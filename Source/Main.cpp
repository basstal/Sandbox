...
private:
	...
	void loadModel()
	{
		model = Model::loadModel((executableDir / "Assets/Models/viking_room.obj").string().c_str());
		image = Image::loadImage((executableDir / "Assets/Textures/viking_room.png").string().c_str());
	}
	...
	{
		auto vertShaderCode = readFile((executableDir / "Shaders/Test_vert.spv").string());
		auto fragShaderCode = readFile((executableDir / "Shaders/Test_frag.spv").string());
